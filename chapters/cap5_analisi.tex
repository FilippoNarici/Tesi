...
\begin{equation}
    ...
    \label{eq:centroide}
\end{equation}
% TODO: Aggiungere a bibliografia 

%fonte: https://color-lab-eilat.github.io/Spectral-sensitivity-estimation-web/
...
%  month = {July}
%  }
I dati di sensibilità spettrale utilizzati sono quelli del Samsung Galaxy S22 Rear Telephoto, adottato come proxy per il sensore del Galaxy S24 per l'obiettivo telephoto, ottenuti dal database pubblico Color Lab Eilat. Lo spettro della sorgente LCD è stato misurato separatamente.
...
% TODO: Fonte è il manuale laboratorio polimi, eccetto correzione lambda, quella lho aggiunta io
...
% TODO: Che strano questo, ma ha senso? Se lo schermo emette in verticale non crea confusione? verificare anche cosa dice il codice per vedere
