...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{@{}l >{\raggedright\arraybackslash}X >{\raggedright\arraybackslash}X@{}}
        ...
        Trave a sbalzo & Fotoelasticità (stress applicato) & Birifrangenza indotta dal carico \\
        \hline
    \end{tabularx}
\end{table}
...
Il vetrino con strati di nastro adesivo trasparente (da 1 a 5 strati, in configurazione simmetrica $1$-$2$-$3$-$4$-$5$-$4$-$3$-$2$-$1$) è un campione a birifrangenza incrementale controllata: il film polimerico del nastro, stirato uniassialmente in fase di produzione, ha le catene molecolari allineate lungo una direzione preferenziale, e questa anisotropia strutturale gli conferisce una birifrangenza intrinseca. La ritardanza totale cresce approssimativamente come
\begin{equation}
