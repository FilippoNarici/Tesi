...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{@{}l >{\raggedright\arraybackslash}X >{\raggedright\arraybackslash}X@{}}
        ...
        \hline
        Lamina $\lambda/2$ (zero-order nominale) & Birifrangenza & $\delta \approx 180^\circ$, AoLP ruotato \\
