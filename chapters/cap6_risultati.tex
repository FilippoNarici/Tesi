...
% DA RIVEDERE MANUALMENTE (ipotesi costruttiva fogli polimerici, su indicazione utente 2026-06-12)
La caratterizzazione delle due lamine, considerata nel suo insieme, suggerisce un'ipotesi costruttiva unitaria, che si avanza qui come interpretazione plausibile e non come conclusione. Entrambe si presentano come dischi di un paio di centimetri di diametro e spessore dell'ordine del millimetro, con superficie liscia e priva di tracce di incollaggio o di struttura a sandwich. Per la $\lambda/2$, all'interno della famiglia di ordini compatibili con l'aliasing, una dispersione debole della birifrangenza seleziona un ordine intorno a $5$--$6$: su uno spessore millimetrico ciò corrisponde a $\Delta n \approx 3{,}5 \cdot 10^{-3}$, valore tipico dei fogli polimerici stirati impiegati industrialmente come film ritardatori, mentre una birifrangenza da cristallo ($\Delta n \approx 10^{-2}$) accumulerebbe sullo stesso spessore oltre una decina di ordini. La depolarizzazione misurata punta nella stessa direzione: cresce verso il blu in modo pressoché identico fra le due lamine ed è indipendente dall'ordine di ritardo, firma di una diffusione interna del materiale piuttosto che di un effetto di banda spettrale, comune nei fogli polimerici e atipica per un cristallo lucidato di grado ottico. A questi indizi misurati si aggiungono considerazioni costruttive: il ritaglio di dischi da fogli birifrangenti commerciali rende conto in modo naturale del diametro, dello spessore uniforme, dell'assenza di incollaggi e del costo contenuto di componenti destinati alla didattica, laddove una vera lamina zero-order in cristallo, ottenuta per compensazione di due lamine multi-ordine sovrapposte, apparterrebbe a una fascia di prezzo e di lavorazione differente. L'ipotesi non contraddice la caratterizzazione adottata per la $\lambda/4$: a tre bande spettrali larghe la sua dispersione, compatibile con un singolo ordine, sarebbe riprodotta altrettanto bene da un multi-ordine avvolto che ne mima l'andamento, e la calibrazione di $S_3$ resta in ogni caso valida, perché fondata sulla misura diretta di $\delta_a$ e non su assunzioni di ordine. Con due soli esemplari e tre bande larghe l'ipotesi del foglio polimerico non è dimostrabile; il suo merito è rendere conto in un quadro unico di spessore, ordine, depolarizzazione e costo.
...
Un quarto fattore, specifico della ritardanza, è l'allineamento geometrico delle lamine. L'inserimento manuale della lamina $\lambda/4$ analizzatore e delle lamine campione non garantisce un'incidenza esattamente normale, e un'inclinazione residua di pochi gradi altera il cammino ottico e la birifrangenza efficace, con una variazione frazionaria del ritardo che cresce quadraticamente con l'angolo. Per una lamina a basso ordine l'effetto è trascurabile, dell'ordine del decimo di grado per inclinazioni di alcuni gradi, e la calibrazione di $S_3$, fondata sulla $\lambda/4$ compatibile con un singolo ordine, ne è di fatto immune; ma poiché la variazione si applica al ritardo \emph{totale}, su una lamina multi-ordine essa si amplifica in proporzione all'ordine, fino a raggiungere alcuni gradi sul valore avvolto, e contribuisce allo scarto residuo osservato sui campioni ad alta ritardanza.
