...
\begin{table}[htbp]
    ...
    \begin{tabularx}{\textwidth}{@{}l *{4}{>{\raggedright\arraybackslash}X}@{}}
        ...
        \hline
        Grandezza misurata & $S_0$--$S_3$ & $S_0$--$S_3$ & $S_0$--$S_2$ (solo lineare) & $S_0$--$S_3$ o matrice di Mueller \\
        Risoluzione spaziale & Sì, 2D & No (puntuale) & Sì, singolo scatto & Sì, 2D \\
        Risoluzione spettrale & Banda larga (Bayer) & Monocromatica o a banda & Banda larga (Bayer) & Monocromatica o iperspettrale \\
        Misura di $S_3$ & Sì (lamina $\lambda/4$ esterna) & Sì & No & Sì \\
        Automazione & Manuale & Motorizzata & Singolo scatto & Motorizzata o attiva \\
        Accuratezza (ordine di grandezza) & $\sim 1$--$5^\circ$ & $\sim 0{,}25^\circ$ & $< 0{,}5^\circ$ & $\lesssim 0{,}1^\circ$ \\
        Costo indicativo & $<$ 100\,\texteuro\ (escl.\ smartphone) & $\sim$ 3000--6000\,\texteuro & $\sim$ 2000--2500\,\texteuro & da $3\times10^4$ a $>10^5$\,\texteuro \\
        \hline
    \end{tabularx}
\end{table}
