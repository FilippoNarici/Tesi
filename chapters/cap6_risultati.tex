...
\begin{table}[H]
    ...
    \begin{tabular}{lcccc}
        ...
        \hline
        Rosso & 626 & $88{,}4$  & $1{,}000$ & $91{,}1$  \\
        Verde & 536 & $111{,}0$ & $1{,}071$ & $107{,}9$ \\
        Blu   & 466 & $130{,}8$ & $1{,}321$ & $126{,}2$ \\
        \hline
    \end{tabular}
\end{table}
...
\begin{table}[H]
    ...
    \begin{tabular}{lcccc}
        ...
        \hline
        Rosso & 626 & $87{,}1$  & $91{,}1$  & $-4{,}0$ \\
        Verde & 536 & $108{,}6$ & $107{,}9$ & $+0{,}7$ \\
        Blu   & 466 & $128{,}5$ & $126{,}2$ & $+2{,}3$ \\
        \hline
    \end{tabular}
\end{table}
...
\subsection{Lamina \texorpdfstring{$\lambda/2$}{lambda/2} (zero-order nominale)}
\label{subsec:risultati_hw}

La lamina mezz'onda, dichiarata dal costruttore zero-order con lunghezza d'onda di design $\lambda_0 = \SI{633}{\nano\meter}$ e orientata a circa \SI{50}{\degree}, è stata analizzata sui tre canali colore con l'obiettivo di validare la ricostruzione della ritardanza in un regime di forte dispersione cromatica, oltre la lunghezza d'onda di progetto; come si vedrà, la misura smentisce il carattere zero-order dichiarato e rivela un ritardatore multi-ordine. La struttura macroscopica del campione è visibile nelle mappe di intensità $S_0$ in \cref{fig:hw_s0}: si distingue il disco centrale della lamina, la montatura metallica circolare che la sostiene e lo sfondo libero illuminato dal display LCD. Il contrasto fra le tre acquisizioni RGB riflette unicamente la trasmissività spettrale del sistema sorgente-lamina-sensore e non dipende dallo stato di polarizzazione locale.
