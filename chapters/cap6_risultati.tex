...
Le possibili cause sono state vagliate una per una. Un errore sistematico della catena di analisi è reso improbabile dal riscontro indipendente offerto dalla lamina $\lambda/4$ (\cref{sec:calibrazione_s3}): la sua ritardanza, misurata con una procedura indipendente dal materiale, segue il modello di dispersione di riferimento entro pochi gradi su tutti i canali, blu compreso, con lo stesso modello di Stokes, la stessa correzione cromatica di $S_3$ e le stesse lunghezze d'onda effettive impiegate qui. Una depolarizzazione differenziale del campione è esclusa dal grado di polarizzazione totale misurato all'interno dei due dischi, che risulta identico fra le due lamine a ciascun canale (circa $0{,}8$ al blu per entrambe) e dunque attribuibile a una causa comune alle due misure, non allo spessore di materiale attraversato. Resta da considerare una dispersione del materiale così anomala da invertire l'andamento geometrico: per produrre una decrescita reale di $\delta$ verso il blu la birifrangenza dovrebbe diminuire più rapidamente di quanto il fattore $1/\lambda$ cresca, un comportamento estraneo a un ritardatore trasparente nel visibile e perciò scartato senza bisogno di ipotesi sul materiale specifico.
