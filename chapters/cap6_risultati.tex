...
L'origine dello scarto resta a oggi non chiarita. La validazione fornita dalla lamina $\lambda/4$ (\cref{subsec:risultati_qw}) esclude che derivi dalla catena di misura, restringendo la causa a una proprietà del singolo campione; lo spessore delle lamine, dell'ordine del millimetro, è inoltre molto maggiore dei circa $\SI{17.6}{\micro\meter}$ di una lamina zero-order in quarzo, condizione che in linea di principio lascerebbe spazio a un comportamento di ordine più elevato. Con tre soli punti spettrali, tuttavia, non è possibile vincolare in modo conclusivo un'eventuale natura multi-ordine né distinguerla da altri effetti sistematici, e si preferisce non avanzare un'attribuzione quantitativa. La discrepanza fra ritardanza misurata e modello zero-order, crescente verso il blu, viene quindi riportata come osservazione aperta: la misura conferma la sensibilità del sistema alla dispersione della ritardanza ma non ne riproduce quantitativamente il valore atteso alle lunghezze d'onda corte.
