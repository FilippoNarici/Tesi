...
- [ ] `chapters/cap4_campioni.tex:15` (trovato 2026-05-21) — le validazioni attese in tab:campioni per le lamine (λ/2: $\delta \approx 180°$ + AoLP ruotato; λ/4: $|S_3/S_0| \approx 1$ a 45°) NON sono riportate esplicitamente in cap6. Valutare di aggiungerle come verifica aggiuntiva: richiede estrarre dalla pipeline $|S_3/S_0|$ max per λ/4 e l'AoLP ruotato per λ/2. Cap6 oggi riporta δ delle lamine ma non questi due check specifici.
