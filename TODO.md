...
Ultimo aggiornamento: 2026-04-23 (correzione ellitticità Poincaré su S3)
...
- [ ] B3: rigenerazione figure su 7 dataset × 3 canali × 9 parametri con nuova correzione Poincaré (stima ~22 min con batch runner). I 189 PDF pre-esistenti sono ora superati dal fix S3.
- [ ] B4: rerun `final_delta_histogram.py` su strati_v2 (3 canali) — gli istogrammi δ sono ora calcolati su δ corretto.
- [ ] Commit modifiche: `align_poincare_ellipticity` + integrazione + debug plot RGB overlay.
